...
export default (BaseComponent) => class WithLogoutButton extends React.Component {
  ...
  getInjection () {
    ...
    const isFetching = isFetchingLogout(state)
    ...
    return {
      ...
      logoutButtonActions: { logout },
      
      logoutButtonComponents: {
        logoutButton: {
          onClick: () => !isFetching && logout()
        }
      }
