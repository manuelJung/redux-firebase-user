...
var User = function (_React$Component) {
  ...
  function User() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = User.__proto__ || Object.getPrototypeOf(User)).call.apply(_ref, [this].concat(args))), _this), _this.unsubscribeStore = null, _this.render = function () {
  ...
  _createClass(User, [{
    ...
    value: function getRenderProps() {
      ...
      return {
        isLoggedIn: (0, _selectors.isLoggedIn)(state),
        profile: (0, _selectors.getUser)(state)
      };
    }
  }]);
...
var withUser = exports.withUser = function withUser(configOrFunc) {
  return function (Component) {
    return function (props) {
      var config = typeof configOrFunc === 'function' ? configOrFunc(props) : configOrFunc;
      return _react2.default.createElement(User, _extends({}, config, { render: function render(data) {
