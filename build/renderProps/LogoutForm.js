...
exports.withLogoutForm = undefined;
...
var LogoutForm = function (_React$Component) {
  ...
  function LogoutForm() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LogoutForm.__proto__ || Object.getPrototypeOf(LogoutForm)).call.apply(_ref, [this].concat(args))), _this), _this.unsubscribeStore = null, _this.render = function () {
...
var withLogoutForm = exports.withLogoutForm = function withLogoutForm(configOrFunc) {
  return function (Component) {
    return function (props) {
      var config = typeof configOrFunc === 'function' ? configOrFunc(props) : configOrFunc;
      return _react2.default.createElement(LogoutForm, _extends({}, config, { render: function render(data) {
