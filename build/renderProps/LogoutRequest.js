...
exports.withLogoutRequest = undefined;
...
var LogoutRequest = function (_React$Component) {
  _inherits(LogoutRequest, _React$Component);
  ...
  function LogoutRequest() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LogoutRequest.__proto__ || Object.getPrototypeOf(LogoutRequest)).call.apply(_ref, [this].concat(args))), _this), _this.unsubscribeStore = null, _this.render = function () {
...
LogoutRequest.contextTypes = {
  store: _propTypes2.default.object
};
LogoutRequest.propTypes = {
  render: _propTypes2.default.func.isRequired
};
exports.default = LogoutRequest;
var withLogoutRequest = exports.withLogoutRequest = function withLogoutRequest(configOrFunc) {
  return function (Component) {
    return function (props) {
      var config = typeof configOrFunc === 'function' ? configOrFunc(props) : configOrFunc;
      return _react2.default.createElement(LogoutRequest, _extends({}, config, { render: function render(data) {
