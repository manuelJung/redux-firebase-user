...
exports.default = function (BaseComponent) {
  ...
  return _temp2 = _class = function (_React$Component) {
    ...
    function WithLoginForm() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WithLoginForm.__proto__ || Object.getPrototypeOf(WithLoginForm)).call.apply(_ref, [this].concat(args))), _this), _this.unsubscribeStore = null, _this.hasMounted = false, _temp), _possibleConstructorReturn(_this, _ret);
    }
      ...
      value: function getInjection() {
        ...
        return {
          ...
          user: {
            ...
            data: (0, _selectors.getUser)(state)
          }
