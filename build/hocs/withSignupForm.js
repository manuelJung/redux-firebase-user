...
exports.default = function (BaseComponent) {
  ...
  return _temp2 = _class = function (_React$Component) {
    _inherits(WithSignupForm, _React$Component);

    function WithSignupForm() {
      var _ref;

      var _temp, _this, _ret;

      _classCallCheck(this, WithSignupForm);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WithSignupForm.__proto__ || Object.getPrototypeOf(WithSignupForm)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        username: '',
        password: ''
      }, _this.unsubscribeStore = null, _this.hasMounted = false, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(WithSignupForm, [{
      ...
      value: function getInjection() {
        ...
        var signup = function signup() {
          return dispatch((0, _actions.signup)(_this3.state.username, _this3.state.password));
        };
        ...
        return {
          ...
          signupFormActions: { clearForm: clearForm, clearPassword: clearPassword, signup: signup },
